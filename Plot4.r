...
png(file="Plot4.png")
par(mfrow=c(2,2))
hist(hpdatasub$Global_active_power,col="red",main="Global Active Power", xlab="Global active power(kilowatts)", ylab="Frequency")
...
plot(hpdatasub$Datetime,hpdatasub$Global_reactive_power,cex=0.6,xlab="",ylab="Global reactive power (kilowatts)")
lines(hpdatasub$Datetime,hpdatasub$Global_reactive_power,cex=0.6)
dev.off()
